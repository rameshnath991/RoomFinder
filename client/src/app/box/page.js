...
const Box = () => {
  ...
  return (
    <div className='flex items-center flex-col p-32'>
      ...
      {generateArea()}
      <Button className='m-1' onClick={()=>dispatch(shiftPosition(-600)) }>Left</Button>
      <Button className='m-1' onClick={()=>dispatch(shiftPosition(600)) } > Right </Button>
      <Button className='m-1' onClick={()=>dispatch(shiftPosition(0)) } >Mid</Button>
      <Button className='m-1' onClick={()=>dispatch(shiftPosition(-100)) }>Top</Button>
      <Button className='m-1' onClick={()=>dispatch(shiftPosition(500)) }>Bottom</Button>
